...
import { Loader2, Mail, Lock, User, ArrowLeft, ShieldCheck, Eye, EyeOff } from "lucide-react";
...
export function SignupForm() {
  ...
  async function handleVerifyOtp() {
    if (!savedFormData || otpCode.length !== 6) {
    ...
    try {
      const verifyRes = await fetch("/api/auth/verify-otp", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ email: savedFormData.email, code: otpCode }),
      });
        ...
        <AnimatePresence mode="wait">
          {step === "form" ? (
            ...
            >
              <CardHeader className="text-center">
                ...
                >
                  ...
                  <CardDescription>Get started with your TODO tracker</CardDescription>
                </motion.div>
              </CardHeader>
            ...
            >
              <CardHeader className="text-center">
                ...
                >
                  ...
                  <CardDescription>
                    ...
                    <span className="font-medium text-foreground">{savedFormData?.email}</span>
                  </CardDescription>
                </motion.div>
              </CardHeader>
              <CardContent className="space-y-4">
              ...
              <CardFooter className="flex flex-col gap-3 border-0 bg-transparent px-4 pt-6 pb-6">
                <Button
                  className="w-full"
